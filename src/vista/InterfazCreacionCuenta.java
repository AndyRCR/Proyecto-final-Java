...
public class InterfazCreacionCuenta extends javax.swing.JFrame {
    ...
    public void comprobarPaciente() {
        ...
        if (validarExistencia == false) {
            validar = PacienteDAO.comprobarPaciente(txtDNI.getText(), txtnombre.getText(), txtapep.getText(), txtapem.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfazCreacionCuenta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
